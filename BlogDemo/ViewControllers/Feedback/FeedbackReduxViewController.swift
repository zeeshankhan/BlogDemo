...
protocol FeedbackReduxViewModelType {
...
final class FeedbackReduxViewController: UIViewController {
    ...
    private let viewModel: FeedbackReduxViewModelType
    private let disposeBag = DisposeBag()

    init(viewModel: FeedbackReduxViewModelType = FeedbackReduxViewModel()) {
